...
+ (void)doPay:(PayOrder *)payOrder AndScheme:(NSString *)scheme seletor:(SEL)seletor target:(id)target
{
    NSString* orderInfo = [self getOrderInfo:payOrder];
...
//将订单对象封装成请求参数
+(NSString*)getOrderInfo:(PayOrder *)payOrder
{
